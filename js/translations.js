...
const translations = {
  ...
  ar: {
    ...
    home: {
      ...
      description: "أنا مهندس ميكاترونيكس خريج جامعة Asia Pacific University في ماليزيا، ولدي خبرة عملية في الرؤية الآلية والأتمتة والروبوتات. عملت على أنظمة فحص في الوقت الفعلي وطورت خوارزميات رؤية متقدمة.",
      contactBtn: "اتصل بي",
